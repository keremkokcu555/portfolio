      ...
      visitorHero.innerHTML = `
        <div class="editorial-hero reveal-on-scroll">
          ...
          <div class="hero-cta-row">
            ...
            ${safeUrl(profile.website) ? `<a class="hero-link" href="${safeUrl(profile.website)}" target="_blank">CV Görüntüle ↗</a>` : ''}
          </div>
      ...
      projHtml += `
        <div class="proj-row">
          ...
          <div class="proj-content">
            ...
            ${safeUrl(p.image) ? `<img src="${safeUrl(p.image)}" style="max-width:100%; border-radius:4px; margin-bottom:24px; border:1px solid var(--border-color);">` : ''}
